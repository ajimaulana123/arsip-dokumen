    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-4">
                <h1 class="h2">Data File</h1>
            </div>
            <div class="d-flex mb-3">
                <form action="" method="GET" class="d-flex">
                    <input type="text" name="search" class="form-control" placeholder="Cari file..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
            ...
            <div class="row">
                ...
                if ($result_files && mysqli_num_rows($result_files) > 0) {
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <?php endif; ?>
                                    <h5 class="card-title mt-3"><?php echo htmlspecialchars($row['document_number']); ?></h5>
                                    <p class="card-text">
                                        <small class="text-muted">
                                            <i class="bi bi-folder me-1"></i> <?php echo htmlspecialchars($row['folder_name']); ?>
                                        </small>
                                    </p>
                                    <p class="card-text">
                                        <small class="text-muted">
                                            <i class="bi bi-calendar me-1"></i> <?php echo date('d/m/Y', strtotime($row['upload_date'])); ?>
                                        </small>
                                    </p>
                    ...
                    echo "<div class='col'><p class='text-center'>Tidak ada file.</p></div>";
                }
                ?>
            </div>
        </main>

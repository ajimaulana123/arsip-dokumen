...
// Query admin users
$query_admin = mysqli_query($koneksi, "SELECT * FROM users WHERE role='admin'");
if ($query_admin) {
    $jumlah_admin = mysqli_num_rows($query_admin);
}

// Query regular users
$query_regular = mysqli_query($koneksi, "SELECT * FROM users WHERE role='user'");
if ($query_regular) {
    $jumlah_user_biasa = mysqli_num_rows($query_regular);
}
...
// Query untuk distribusi jabatan
$jabatan_data = [];
$sql_jabatan = "SELECT 
    ...
    <script>
        ...
        new Chart(document.getElementById('userDistributionChart'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo $jumlah_admin; ?>, <?php echo $jumlah_user_biasa; ?>],
